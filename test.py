...
class JobApplicationBot:
    def __init__(self):
        ...
        # Create tasks and pass agents to them
        self.tasks = tasks(self.agents)
        
        # Create the crew which will execute tasks sequentially.
        self.crew = Crew(
    ...
    def run(self, resume_path, job_keywords=None, location=None, experience_level=None, user_info=None):
        ...
        # 2. Search for jobs
        print("🔎 Searching for jobs matching resume skills")
        ...
        print("✏️ Tailoring resume to match job descriptions")
...
def main():
    ...
    if "job_applications" in result:
        ...
        if isinstance(applications, list) and applications:
            ...
            print("No applications submitted or no results available")
    else:
